pipeline {
    ...
    stages {
        ...
        stage('Test (Control de Calidad)') {
            steps {
                ...
                // Ejecutamos el test dentro del contenedor recién creado [cite: 108, 109]
        ...
        stage('Deploy (Entrega)') {
            steps {
                ...
                // Eliminamos versiones antiguas si existen para evitar conflictos [cite: 117]
                sh 'docker rm -f burger-prod || true'
                // Lanzamos la nueva versión en el puerto 5000 [cite: 118]
    ...
    post {
        always {
            ...
            // Mantenemos el entorno limpio de imágenes huérfanas [cite: 178]
